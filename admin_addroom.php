...
if(isset($_POST["addbtn"]))
{
    ...
    $nplace_id = $_POST['place_id'];
    $nroom_num = $_POST['room_num'];
    $nroom_rent = $_POST['room_rent'];
    $nroom_status = $_POST['room_status'];

    $ridresult=mysql_query("select * from room where place_id='$nplace_id'");
    if(empty($nplace_id) || empty($nroom_num)|| empty($nroom_rent))
    {
      ?>
          <script type="text/javascript">
            alert("Please fill in place_id, room number and room rental");
          </script>

      <?php
    }
    else if((mysql_num_rows($ridresult)!=0))
    {
      ?>
      <script type="text/javascript">
        alert("The place ID is exist.");
      </script>
      <?php
    }
    else
        ...
        <li>
             ...
             <div class="collapse navbar-collapse navbar-ex1-collapse">
              ...
              <ul class="nav navbar-nav side-nav">
                ...
                <li class="active">
                  <a href="admin_index.php"><i class="fa fa-fw fa-table"></i> Add Room</a>
                </li>
                  ...
                  <div class="form-group">
                    <table style="width:780px;">
                        <tr style="height:50px;">
                          <th colspan="2" style="color:orange;text-align:center;font-size:20px;">Room</th>

                        </tr>
                        <tr style="height:50px;">
                          <th style="color:skyblue;text-align:center;">Place ID</th>
                          <td><input class="form-control" placeholder="" name="place_id" type="text" value=""></td>

                        </tr>
                        <tr style="height:50px;">
                          <th style="color:skyblue;text-align:center;">Room number</th>
                          <td><input class="form-control" placeholder="" name="room_num" type="number" value=""></td>
                        </tr>
                        <tr style="height:50px;">
                          <th style="color:skyblue;text-align:center;">Room Rental</th>
                          <td><input class="form-control" placeholder="" name="room_rent" type="number" value=""></td>
                        </tr>
                        
                        <tr style="height:50px;">
                          <th style="color:skyblue;text-align:center;">Room Status</th>
                          <td><input class="form-control" placeholder="" name="room_status" type="text" value="None" readonly></td>
